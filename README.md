...
2. Wait for App **Started** and a Core restart after thin-integration sync (App **0.1.26+** auto-requests Core restart after sync; **0.1.27+** also shows **Restart required** on Settings → System → Updates until Core reloads).

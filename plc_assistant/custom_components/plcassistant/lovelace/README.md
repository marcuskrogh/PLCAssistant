...
**0.1.52** Operate is a SCADA HMI (status, Start/Stop/Reset, Mode, key PVs, PID cards) — not an entity dump. Tap Process values for history. Stock Lovelace refreshes to dashboard version **28**.

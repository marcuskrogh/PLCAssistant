"""HA-local Datablock catalog (SWD-184 / SWD-219).

Owned by the thin HA integration. Must not import Soft-PLC ``plcassistant``.
Keep defaults parity-tested against ``plcassistant.io.datablock``.
"""
    ...
    return datablock_from_dict(
        {
            ...
            "tags": {
                ...
                "LEVEL_U0": {"default": 0.0, "unit": None},
                "LEVEL_BETA": {"default": 1.0, "unit": None},
                "LEVEL_DIRECT_ACTING": {"default": 0.0, "unit": None},
                "LEVEL_CV_MIN": {"default": 0.0, "unit": "L/min"},
                "LEVEL_CV_MAX": {"default": 8.0, "unit": "L/min"},
                ...
                "FLOW_U0": {"default": 0.0, "unit": None},
                "FLOW_BETA": {"default": 1.0, "unit": None},
                "FLOW_DIRECT_ACTING": {"default": 0.0, "unit": None},
                "FLOW_CV_MIN": {"default": 0.0, "unit": "pct"},
                "FLOW_CV_MAX": {"default": 100.0, "unit": "pct"},
            ...
            "bindings": [
                ...
                {
                    "tag": "LEVEL_U0",
                    "entity": "number.plcassistant_level_u0",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_BETA",
                    "entity": "number.plcassistant_level_beta",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_DIRECT_ACTING",
                    "entity": "number.plcassistant_level_direct_acting",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_CV_MIN",
                    "entity": "number.plcassistant_level_cv_min",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_CV_MAX",
                    "entity": "number.plcassistant_level_cv_max",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_HOLD_WHEN_STOPPED",
                    "entity": "number.plcassistant_level_hold_when_stopped",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_TS",
                    "entity": "number.plcassistant_level_ts",
                    "direction": "IN",
                },
                {
                    "tag": "LEVEL_TF_TS",
                    "entity": "number.plcassistant_level_tf_ts",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_U0",
                    "entity": "number.plcassistant_flow_u0",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_BETA",
                    "entity": "number.plcassistant_flow_beta",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_DIRECT_ACTING",
                    "entity": "number.plcassistant_flow_direct_acting",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_CV_MIN",
                    "entity": "number.plcassistant_flow_cv_min",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_CV_MAX",
                    "entity": "number.plcassistant_flow_cv_max",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_HOLD_WHEN_STOPPED",
                    "entity": "number.plcassistant_flow_hold_when_stopped",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_TS",
                    "entity": "number.plcassistant_flow_ts",
                    "direction": "IN",
                },
                {
                    "tag": "FLOW_TF_TS",

...
- **Mock / sim** entities (mock path ≡ field path)
- Operator services **start / stop / reset** (MQTT cmd topics)

Talks to the Soft-PLC **App** over MQTT. See [`docs/packaging/`](../../docs/packaging/README.md) and [`ha_app/INSTALL.md`](../../ha_app/INSTALL.md).

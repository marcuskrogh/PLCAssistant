...
_TAG_META: dict[str, dict] = {
    ...
    "LEVEL_U0": {
        "name": "PLCAssistant Level u0",
        "min": -1000.0,
        "max": 1000.0,
        "step": 0.01,
        "object_id": "plcassistant_level_u0",
        "default": 0.0,
    },
    "LEVEL_BETA": {
        "name": "PLCAssistant Level beta",
        "min": 0.0,
        "max": 2.0,
        "step": 0.01,
        "object_id": "plcassistant_level_beta",
        "default": 1.0,
    },
    "LEVEL_DIRECT_ACTING": {
        "name": "PLCAssistant Level direct acting",
        "min": 0.0,
        "max": 1.0,
        "step": 1.0,
        "object_id": "plcassistant_level_direct_acting",
        "default": 0.0,
    },
    "LEVEL_CV_MIN": {
        "name": "PLCAssistant Level CV min",
        "min": 0.0,
        "max": 8.0,
        "step": 0.1,
        "unit": "L/min",
        "object_id": "plcassistant_level_cv_min",
        "default": 0.0,
    },
    "LEVEL_CV_MAX": {
        "name": "PLCAssistant Level CV max",
        "min": 0.0,
        "max": 8.0,
        "step": 0.1,
        "unit": "L/min",
        "object_id": "plcassistant_level_cv_max",
        "default": 8.0,
    },
    "LEVEL_HOLD_WHEN_STOPPED": {
        "name": "PLCAssistant Level hold when stopped",
        "min": 0.0,
        "max": 1.0,
        "step": 1.0,
        "object_id": "plcassistant_level_hold_when_stopped",
        "default": 1.0,
    },
    "LEVEL_TS": {
        "name": "PLCAssistant Level Ts",
        "min": 0.01,
        "max": 10.0,
        "step": 0.01,
        "unit": "s",
        "object_id": "plcassistant_level_ts",
        "default": 0.1,
    },
    "LEVEL_TF_TS": {
        "name": "PLCAssistant Level Tf/Ts",
        "min": 0.0,
        "max": 1000.0,
        "step": 0.1,
        "object_id": "plcassistant_level_tf_ts",
        "default": 0.0,
    },
    "FLOW_U0": {
        "name": "PLCAssistant Flow u0",
        "min": -1000.0,
        "max": 1000.0,
        "step": 0.01,
        "object_id": "plcassistant_flow_u0",
        "default": 0.0,
    },
    "FLOW_BETA": {
        "name": "PLCAssistant Flow beta",
        "min": 0.0,
        "max": 2.0,
        "step": 0.01,
        "object_id": "plcassistant_flow_beta",
        "default": 1.0,
    },
    "FLOW_DIRECT_ACTING": {
        "name": "PLCAssistant Flow direct acting",
        "min": 0.0,
        "max": 1.0,
        "step": 1.0,
        "object_id": "plcassistant_flow_direct_acting",
        "default": 0.0,
    },
    "FLOW_CV_MIN": {
        "name": "PLCAssistant Flow CV min",
        "min": 0.0,
        "max": 100.0,
        "step": 0.1,
        "unit": "%",
        "object_id": "plcassistant_flow_cv_min",
        "default": 0.0,
    },
    "FLOW_CV_MAX": {
        "name": "PLCAssistant Flow CV max",
        "min": 0.0,
        "max": 100.0,
        "step": 0.1,
        "unit": "%",
        "object_id": "plcassistant_flow_cv_max",
        "default": 100.0,
    },
    "FLOW_HOLD_WHEN_STOPPED": {
        "name": "PLCAssistant Flow hold when stopped",
        "min": 0.0,
        "max": 1.0,
        "step": 1.0,
        "object_id": "plcassistant_flow_hold_when_stopped",
        "default": 0.0,
    },
    "FLOW_TS": {
        "name": "PLCAssistant Flow Ts",
        "min": 0.01,
        "max": 10.0,
        "step": 0.01,
        "unit": "s",
        "object_id": "plcassistant_flow_ts",
        "default": 0.1,
    },
    "FLOW_TF_TS": {
        "name": "PLCAssistant Flow Tf/Ts",
        "min": 0.0,
        "max": 1000.0,
        "step": 0.1,

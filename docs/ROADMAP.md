...
| 5 | Packaging shape | Hybrid HA App + thin integration (MQTT); HA OS; custom GitHub App | implement → review-fix | [SWD-84](https://marcusknielsen.atlassian.net/browse/SWD-84) · [`docs/PLAN.md`](PLAN.md) · [`docs/packaging/`](packaging/) |
...
## Next
`/review-fix SWD-84` — Packaging implement ready for review-fix

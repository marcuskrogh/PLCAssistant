...
| 3 | Control semantics | What “PLC-like” means here: loops, feedback, safety, timing — without locking runtime design yet | implement → review-fix | [SWD-85](https://marcusknielsen.atlassian.net/browse/SWD-85) |

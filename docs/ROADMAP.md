...
## Open questions
- Where the PLC runtime should live relative to HA (inside vs beside), and what “integration” vs “app” should mean (preliminary: Add-on + thin integration)
...
- Tasks: [SWD-83](https://marcusknielsen.atlassian.net/browse/SWD-83) **Done**, [SWD-86](https://marcusknielsen.atlassian.net/browse/SWD-86), [SWD-85](https://marcusknielsen.atlassian.net/browse/SWD-85), [SWD-82](https://marcusknielsen.atlassian.net/browse/SWD-82), [SWD-84](https://marcusknielsen.atlassian.net/browse/SWD-84)

## Next
`/define SWD-86` — Define theme: HA entities as PLC I/O

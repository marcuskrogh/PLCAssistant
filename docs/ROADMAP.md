...
| 4 | Programming surface | Easy high-level entry with a deep customization path | define done → implement | [SWD-82](https://marcusknielsen.atlassian.net/browse/SWD-82) · [`docs/PLAN.md`](PLAN.md) · [`docs/RESEARCH.md`](RESEARCH.md) |
...
## Next
`/implement SWD-82` — Programming surface per [`docs/PLAN.md`](PLAN.md)

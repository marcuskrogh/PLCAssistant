...
| 5 | Packaging shape | Integration vs app/add-on vs hybrid — still intentionally open | research → define | [SWD-84](https://marcusknielsen.atlassian.net/browse/SWD-84) · [`docs/RESEARCH.md`](RESEARCH.md) |

...
| 2 | HA entities as PLC I/O | Core inversion: devices live in HA, then participate in PLC-style control | **Review CLEAN** — ready to ship | [SWD-86](https://marcusknielsen.atlassian.net/browse/SWD-86) |

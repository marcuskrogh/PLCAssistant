...
| 4 | Programming surface | Easy high-level entry with a deep customization path | define → implement | [SWD-82](https://marcusknielsen.atlassian.net/browse/SWD-82) |
...
- ~~How progressive the easy→customizable programming path should feel~~ — locked in SWD-82 PLAN: L0–L3 (BT L1, YAML artifact)
...
- Tasks: [SWD-83](https://marcusknielsen.atlassian.net/browse/SWD-83) **Done**, [SWD-86](https://marcusknielsen.atlassian.net/browse/SWD-86) **Done**, [SWD-85](https://marcusknielsen.atlassian.net/browse/SWD-85) **Done**, [SWD-82](https://marcusknielsen.atlassian.net/browse/SWD-82) (plan: `docs/PLAN.md`), [SWD-84](https://marcusknielsen.atlassian.net/browse/SWD-84)

## Next
`/implement SWD-82` — Programming surface (plan: `docs/PLAN.md`)

...
| 5 | Packaging shape | Integration vs app/add-on vs hybrid — still intentionally open | define → implement | [SWD-84](https://marcusknielsen.atlassian.net/browse/SWD-84) · [`docs/PLAN.md`](PLAN.md) · [`docs/RESEARCH.md`](RESEARCH.md) |
...
## Next
`/implement SWD-84` — Packaging shape plan ready; build per `docs/PLAN.md`

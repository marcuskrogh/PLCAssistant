...
|-----|------|-------|--------|--------|----------|------|
| SWD-230 | Bug | [Iterate] PID cards: match Lovelace fonts/sizes + force 2dp on all values | In Review | Relates SWD-229 | docs/ITERATE.md | `/review-fix SWD-230` — PR [#93](https://github.com/marcuskrogh/PLCAssistant/pull/93) |

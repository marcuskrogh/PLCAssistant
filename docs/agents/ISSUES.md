...
|-----|------|-------|--------|--------|----------|------|
| SWD-251 | Bug | [Iterate] Simplify pump flow limits — one capacity knob that stays in sync | In Review | Relates SWD-250 | docs/ITERATE.md | `/review-fix SWD-251` — [PR #99](https://github.com/marcuskrogh/PLCAssistant/pull/99) (App 0.1.54) |

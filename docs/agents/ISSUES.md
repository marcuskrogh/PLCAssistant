...
|-----|------|-------|--------|--------|----------|------|
| SWD-250 | Bug | PID diagram clipping + wrong CV max; model settings hard to edit | To Do | Relates SWD-249 | docs/BUG.md | `/implement SWD-250` — Fix per BUG.md on `cursor/swd-250-pid-cvmax-model-9910` |

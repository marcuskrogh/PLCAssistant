...
| SWD-168 | Task | [Iterate] Show Restart required on Settings updates page after PLCAssistant integration sync | In Progress | Relates SWD-138 | docs/ITERATE.md | `/review-fix SWD-168` |

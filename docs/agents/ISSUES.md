...
|-----|------|-------|--------|--------|----------|------|
| SWD-250 | Bug | PID diagram clipping + wrong CV max; model settings hard to edit | In Progress | Relates SWD-249 | docs/BUG.md | implementing — packages 1–3 on PR [#98](https://github.com/marcuskrogh/PLCAssistant/pull/98) |

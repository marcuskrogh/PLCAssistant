...
| SWD-223 | Bug | [Iterate] Level/Flow PID Manual SP does not drive CV (post 0.1.42) | In Progress | Relates SWD-222 | docs/ITERATE.md | Implement complete — App 0.1.43; Next `/review-fix SWD-223` |

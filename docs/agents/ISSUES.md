...
| SWD-178 | Story | Industrial-parity Soft-PLC programming surface (multi-program) | To Do | — | docs/ROADMAP.md, docs/RESEARCH.md, docs/PLAN.md | `/ship SWD-180` |
...
| SWD-180 | Task | Library inspectability + generic PID | In Review | Relates SWD-178; blocked by SWD-182 | docs/PLAN.md | `/review-fix SWD-180` |

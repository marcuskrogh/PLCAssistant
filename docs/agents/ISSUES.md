...
|-----|------|-------|--------|--------|----------|------|
| SWD-250 | Bug | PID diagram clipping + wrong CV max; model settings hard to edit | In Review | Relates SWD-249 | docs/BUG.md | `/review-fix SWD-250` — PR [#98](https://github.com/marcuskrogh/PLCAssistant/pull/98) (App 0.1.53) |

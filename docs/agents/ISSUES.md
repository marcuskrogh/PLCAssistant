...
|-----|------|-------|--------|--------|----------|------|
| SWD-81 | Story | PLCAssistant — Virtual PLC for Home Assistant | To Do | — | docs/ROADMAP.md | `/review-fix SWD-84` |
...
| SWD-84 | Task | Explore theme: Packaging shape | In Review | SWD-81 | docs/PLAN.md, docs/packaging/, ha_app/, custom_components/plcassistant/ | `/review-fix SWD-84` |

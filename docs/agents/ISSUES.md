...
|-----|------|-------|--------|--------|----------|------|
| SWD-66 | Story | PLCAssistant: virtual PLC for Home Assistant | To Do | | docs/ROADMAP.md | `/research SWD-70` or `/define SWD-70` |
| SWD-70 | Task | Architecture & approach selection for virtual PLC over HA entities | To Do | SWD-66 | docs/ROADMAP.md | `/research SWD-70` or `/define SWD-70` |

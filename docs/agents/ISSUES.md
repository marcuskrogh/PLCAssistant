...
|-----|------|-------|--------|--------|----------|------|
| SWD-367 | Task | Iterate: Align builtin PID with IFAC 2024 reference implementation | In Progress | Relates SWD-360, SWD-366 | docs/ITERATE.md | `/review-fix SWD-367` |
...
- 2026-08-17 — Iterate SWD-367: IFAC 2024 incremental PID (filter, Tx, auto/uman, windup); Relates SWD-360/366; App 0.1.57. Next `/review-fix SWD-367`.

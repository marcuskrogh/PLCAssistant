...
|-----|------|-------|--------|--------|----------|------|
| SWD-66 | Story | PLCAssistant: virtual PLC for Home Assistant | To Do | | docs/ROADMAP.md | `/define SWD-71` |
...
| SWD-71 | Task | HA entity I/O bridge for PLC tags | To Do | SWD-66 | docs/IO_HAL.md | `/define SWD-71` |

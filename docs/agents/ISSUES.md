...
|-----|------|-------|--------|--------|----------|------|
| SWD-249 | Bug | One-tank Diagram empty; mobile cannot place blocks | To Do | Relates SWD-237 | docs/BUG.md | `/implement SWD-249` |
...
- 2026-08-04 — Bug SWD-249: one-tank Diagram empty + mobile place; Relates SWD-237; branch `cursor/swd-249-empty-diagram-1e05`; docs/BUG.md. Next `/implement SWD-249`.

...
|-----|------|-------|--------|--------|----------|------|
| SWD-251 | Bug | [Iterate] Simplify pump flow limits — one capacity knob that stays in sync | In Progress | Relates SWD-250 | docs/ITERATE.md | `/review-fix SWD-251` after PR |
...
- 2026-08-04 — Iterate SWD-251: simplify pump flow limits (one Max pump flow knob + Soft-PLC sync); Relates SWD-250; branch `cursor/swd-251-simplify-pump-flow-limits-3043`; docs/ITERATE.md. Next `/review-fix SWD-251`.

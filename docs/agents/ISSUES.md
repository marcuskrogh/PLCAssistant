...
| SWD-178 | Story | Industrial-parity Soft-PLC programming surface (multi-program) | To Do | — | docs/ROADMAP.md, docs/RESEARCH.md, docs/PLAN.md | `/ship SWD-191` |
...
| SWD-191 | Task | Task/Program scheduling editor | In Progress | Relates SWD-178; blocked by SWD-181 | docs/PLAN.md | `/ship SWD-191` |
| SWD-196 | Subtask | SWD-191: Schema + persist/apply split | To Do | SWD-191 | docs/PLAN.md | — |
| SWD-199 | Subtask | SWD-191: Task editor API | To Do | SWD-191 | docs/PLAN.md | — |
| SWD-200 | Subtask | SWD-191: App UI top nav + Task editor | To Do | SWD-191 | docs/PLAN.md | — |
| SWD-197 | Subtask | SWD-191: Wire Program cards status after Apply | To Do | SWD-191 | docs/PLAN.md | — |
| SWD-198 | Subtask | SWD-191: unit + integration + system tests | To Do | SWD-191 | docs/PLAN.md | — |

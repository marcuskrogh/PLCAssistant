...
| SWD-179 | Task | Research: industrial PLC program organization & engineering UI capabilities | To Do | Relates SWD-178, SWD-173 | docs/RESEARCH.md | `/explore SWD-178` (PR [#75](https://github.com/marcuskrogh/PLCAssistant/pull/75)) |

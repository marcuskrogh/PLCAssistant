...
| SWD-141 | Bug | [Iterate] Level setpoint request does not update Active level SP (stuck 0.2 m) | In Progress | Relates SWD-140 | docs/ITERATE.md | Implement → review-fix |

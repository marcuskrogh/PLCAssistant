...
|-----|------|-------|--------|--------|----------|------|
| SWD-66 | Story | PLCAssistant: virtual PLC for Home Assistant | To Do | | docs/ROADMAP.md | `/review-fix SWD-71` |
...
| SWD-71 | Task | HA entity I/O bridge for PLC tags | In Review | SWD-66 | docs/PLAN.md | `/review-fix SWD-71` |

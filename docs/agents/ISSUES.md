...
| SWD-140 | Bug | [Iterate] HMI zeros on SP_LEVEL/SP_FLOW/LT_RES + clarify PERM_OK while RUNNING | In Progress | Relates SWD-139 | docs/ITERATE.md | Implement → review-fix |

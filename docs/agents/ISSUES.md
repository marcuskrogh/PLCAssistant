...
|-----|------|-------|--------|--------|----------|------|
| SWD-252 | Task | Cloud agents refresh marcuskrogh/skills on every boot | In Review | — | AGENTS.md, .cursor/environment.json | review-fix CLEAN → ship — PR [#100](https://github.com/marcuskrogh/PLCAssistant/pull/100) |

...
def test_app_version_0_1_53():
    ...
    assert 'version: "0.1.63"' in Path("plc_assistant/config.yaml").read_text(encoding="utf-8")
    assert "BUILD_VERSION=0.1.63" in Path("plc_assistant/Dockerfile").read_text(encoding="utf-8")

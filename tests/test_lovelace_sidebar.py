...
def test_bundled_yaml_exists() -> None:
    ...
    assert "plcassistant_dashboard_version: 25" in text
...
def test_run_sh_refreshes_stock_missing_status_not_custom() -> None:
    ...
    # Explicit old versions only — refresh 1–24 stock boards to v25 (SWD-226).
    assert "plcassistant_dashboard_version:[[:space:]]*([1-9]|1[0-9]|20|21|22|23|24)" in text
